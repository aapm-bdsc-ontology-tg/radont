 ...
 * [radont.yml](radont.yml)
     * Determines how your purl.obolibrary.org/obo/radont/ redirects will be handled
     ...
     * Paste in the contents of [radont.yml](radont.yml)
 ...
 * [radont.md](radont.md)
     ...
     * Paste in the contents of [radont.md](radont.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
