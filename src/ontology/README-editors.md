These notes are for the EDITORS of radont
...
Make sure you have an ID range in the [idranges file](radont-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [radont-edit.owl](radont-edit.owl)

** DO NOT EDIT radont.obo OR radont.owl in the top level directory **

[../../radont.owl](../../radont.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/aapm-bdsc-ontology-tg/radont) for details.
 ...
 * [radont-idranges.owl](radont-idranges.owl)
...
There are two ways to include new classes in an import module
 ...
 2. Add to the imports/radont_terms.txt file
...
Note: the radont_terms.txt file may include 'starter' classes seeded from
...
This generates derived files such as radont.owl and radont.obo and places
 ...
 * https://github.com/aapm-bdsc-ontology-tg/radont/releases
 * https://github.com/aapm-bdsc-ontology-tg/radont/releases/new
...
what is in the `owl:versionIRI` of the derived radont.owl (`data-version` in
radont.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/radont.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/radont/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/aapm-bdsc-ontology-tg/radont.svg?branch=master)](https://travis-ci.org/aapm-bdsc-ontology-tg/radont)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/aapm-bdsc-ontology-tg](https://travis-ci.org/profile/aapm-bdsc-ontology-tg)
 2. click the "Sync account" button
 3. Click the tick symbol next to radont
